...
class TwoSumPracticeTests extends AnyFunSpec {
  describe("Two Sum Practice tests") {
    it(
      ...
      val target = 0;
      assert(Practice.twoSum(nums, target).toList == List(0, 3))
    }
    ...
    it(
      ...
      val target = 9;
      assert(Practice.twoSum(nums, target).toList == List(0, 1))
    }
    ...
    it(
      ...
      val target = 9
      assert(Practice.twoSum(nums, target).toList == List(1, 3))
    }
    ...
    it(
      ...
      val target = 9
      assert(Practice.twoSum(nums, target).toList == List(2, 3))
    }
    ...
    it(
      ...
      val target = 11
      assert(Practice.twoSum(nums, target).toList == List(5, 11))
    }
  }
}
